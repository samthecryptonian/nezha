...
func (ma *memberAPI) addOrEditAlertRule(c *gin.Context) {
	...
	if err == nil {
		...
		r.Enable = &enable
		r.ID = arf.ID
		r.SendRecoveryMessage = arf.SendRecoveryMessage == "on"
		r.MessageTemplate = arf.MessageTemplate
		r.RecoveryMessageTemplate = arf.RecoveryMessageTemplate
	}
	if err == nil {
